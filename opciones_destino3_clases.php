...
<body>
  ...
  <div class="main-cajon">
    ...
    <div class="form-container">
      <img src="https://estudiarenusa.com/wp-content/uploads/2022/11/1508253136798.jpg" alt="Regiones de Canada">
      <form id="regionForm">
        <select id="region" required>
          <option value="">Seleccione una región...</option>
          <option value="ProvinciasAtlanticas">Las provincias atlanticas</option>
          <option value="CanadaCentral">Canada central</option>
          <option value="PraderasCanadienses">Las praderas canadienses</option>
          <option value="CostaPacifica">Costa pacifica</option>
          <option value="TerritoriosNorte">Los territorios del norte</option>          
        </select>
