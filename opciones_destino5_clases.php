...
<body>
  ...
  <div class="main-cajon">
    ...
    <div class="form-container">
      <img src="https://egipto.es/wp-content/uploads/2021/11/geografia-de-egipto-1152x759.jpg" alt="Regiones de Egipto">
      <form id="regionForm">
        <select id="region" required>
          <option value="">Seleccione una región...</option>
          <option value="ValleNilo">El valle del nilo</option>
          <option value="DeltaNilo">El delta del nilo</option>
          <option value="DesiertoOccidental">El desierto occidental</option>
          <option value="DesiertoOriental">El desierto oriental</option>
          <option value="PeninsulaSinai">La peninsula del sinai</option>
        </select>
