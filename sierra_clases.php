...
<head>
  ...
  <title>Clase 1 - Región Sierra - Aerolingo</title>
...
<body>
 ...
 <div id="mySidebar" class="sidebar">
  ...
  <h1>Comencemos!!!</h1>
  <h2>Clase 1 - Región Sierra - Perú </h2>
  <p>Accion que hace el ser humano para recuperar las energias que ha perdido en el dia .</p>  
  <p>Es conocido como Jatear:</p>
  

  <div class="options">
    <div class="option" onclick="checkAnswer('wrong', this)"> 
      <p>Opción 1</p>
      <img src="https://i.ytimg.com/vi/g_aWb2C4n6o/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLCiL3E9I8rJ_onpfmHk0FOGTtFqUg" alt="aguacate" id="aguacate">
    </div>
    <div class="option" onclick="checkAnswer('wrong', this)"> 
      <p>Opción 2</p>
      <img src="https://segurossura.com/content/uploads/sites/10/2020/12/como-puedes-hablar-mejor.jpg" alt="palta" id="palta">
    </div>
    <div class="option" onclick="checkAnswer('correct', this)"> 
      <p>Opción 3</p>
      <img src="https://media.gq.com.mx/photos/61a8f42072230ae2add7b0c5/4:3/w_2664,h_1998,c_limit/DORMIR.jpg" alt="kiwi" id="kiwi">
    </div>
     <div class="option" onclick="checkAnswer('wrong', this)"> 
      <p>Opción 4</p>
      <img src="https://www.bmsupermercados.es/fotografias/noticias/bm-running-postura-tecnica.jpg" alt="piña" id="piña">
    </div>
  </div>

  <p class="correct-answer" id="correctAnswer">¡Correcto! La respuesta es la opcion 3.</p>
  <p class="incorrect-answer" id="incorrectAnswer">¡Incorrecto! La respuesta es la opcion 3.</p>
