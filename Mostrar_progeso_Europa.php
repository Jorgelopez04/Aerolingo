...
<body>
  ...
  <div class="progress-container">
    <h1 class="progress-title">Progreso en tu viaje a Portugal</h1> <!-- Título general -->
    <p class="progress-text">Tu progreso es el siguiente</p>

    <div class="charts-container">
      <div class="chart-item">
        <canvas id="chartContinental"></canvas>
        <p>Portugal continental</p>
      </div>
      <div class="chart-item">
        <canvas id="chartAutonomas"></canvas>
        <p>Regiones Autonomas</p>
      </div>      
      <div class="chart-item">
        <canvas id="chartTotalPortugal"></canvas>
        <p>Total</p>
      </div>
    </div>
  </div>
  ...
  <script>
    // Gráficos circulares
    const dataContinental = { labels: ['Completado', 'Pendiente'], datasets: [{ data: [0, 100], backgroundColor: ["#36A2EB", "#FF6384"] }] };
    const dataAutonomas = { labels: ['Completado', 'Pendiente'], datasets: [{ data: [0, 100], backgroundColor: ["#36A2EB", "#FF6384"] }] };
    const dataTotalPortugal = { labels: ['Completado', 'Pendiente'], datasets: [{ data: [0, 100], backgroundColor: ["#36A2EB", "#FF6384"] }] };
    
    

    new Chart(document.getElementById('chartContinental'), { type: 'doughnut', data: dataContinental});
    new Chart(document.getElementById('chartAutonomas'), { type: 'doughnut', data: dataAutonomas });
    new Chart(document.getElementById('chartTotalPortugal'), { type: 'doughnut', data: dataTotalPortugal });
