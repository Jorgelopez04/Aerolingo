...
<body>
  ...
  <div class="progress-container">
    <h1 class="progress-title">Progreso en tu viaje a Perú</h1>
    <p class="progress-text">Tu progreso es el siguiente</p>

    <div class="charts-container">
      <div class="chart-item">
        <canvas id="chartSelva"></canvas>
        <p>Selva</p>
      </div>
      <div class="chart-item">
        <canvas id="chartSierra"></canvas>
        <p>Sierra</p>
      </div>
      <div class="chart-item">
        <canvas id="chartCosta"></canvas>
        <p>Costa</p>
      </div>
      <div class="chart-item">
  ...
  <!-- Segundo Contenedor de Progreso -->
  <div class="progress-container">
  ...
  <script>
    ...
    const dataSelva = { labels: ['Completado', 'Pendiente'], datasets: [{ data: [70, 30], backgroundColor: ["#36A2EB", "#FF6384"] }] };
    const dataSierra = { labels: ['Completado', 'Pendiente'], datasets: [{ data: [50, 50], backgroundColor: ["#36A2EB", "#FF6384"] }] };
    const dataCosta = { labels: ['Completado', 'Pendiente'], datasets: [{ data: [90, 10], backgroundColor: ["#36A2EB", "#FF6384"] }] };
    const dataTotal = { labels: ['Completado', 'Pendiente'], datasets: [{ data: [80, 20], backgroundColor: ["#36A2EB", "#FF6384"] }] };

    new Chart(document.getElementById('chartSelva'), { type: 'doughnut', data: dataSelva });
    new Chart(document.getElementById('chartSierra'), { type: 'doughnut', data: dataSierra });
    new Chart(document.getElementById('chartCosta'), { type: 'doughnut', data: dataCosta });
    new Chart(document.getElementById('chartTotal'), { type: 'doughnut', data: dataTotal });
