...
<body>
  ...
  <div class="progress-container">
    <h1 class="progress-title">Progreso en tu viaje a Egipto</h1> <!-- Título general -->
    <p class="progress-text">Tu progreso es el siguiente</p>

    <div class="charts-container">
      <div class="chart-item">
        <canvas id="chartValleNilo"></canvas>
        <p>El valle del nilo</p>
      </div>
      <div class="chart-item">
        <canvas id="chartDeltaNilo"></canvas>
        <p>El delta del nilo</p>
      </div>
      <div class="chart-item">
        <canvas id="chartDesiertoOccidental"></canvas>
        <p>El desierto occidental</p>
      </div>
      <div class="chart-item">
        <canvas id="chartDesiertoOriental"></canvas>
        <p>El desierto oriental</p>
      </div>
      <div class="chart-item">
        <canvas id="chartPeninsulaSinai"></canvas>
        <p>La peninsula del sinai</p>
      </div>
      <div class="chart-item">
        <canvas id="chartTotalEgipto"></canvas>
        <p>Total</p>
      </div>
    </div>
  </div>
  ...
  <script>
    // Gráficos circulares
    const dataValleNilo = { labels: ['Completado', 'Pendiente'], datasets: [{ data: [0, 100], backgroundColor: ["#36A2EB", "#FF6384"] }] };
    const dataDeltaNilo = { labels: ['Completado', 'Pendiente'], datasets: [{ data: [0, 100], backgroundColor: ["#36A2EB", "#FF6384"] }] };
    const dataDesiertoOccidental = { labels: ['Completado', 'Pendiente'], datasets: [{ data: [0, 100], backgroundColor: ["#36A2EB", "#FF6384"] }] };
    const dataDesiertoOriental = { labels: ['Completado', 'Pendiente'], datasets: [{ data: [0, 100], backgroundColor: ["#36A2EB", "#FF6384"] }] };
    const dataPeninsulaSinai = { labels: ['Completado', 'Pendiente'], datasets: [{ data: [0, 100], backgroundColor: ["#36A2EB", "#FF6384"] }] };
    const dataTotalEgipto = { labels: ['Completado', 'Pendiente'], datasets: [{ data: [0, 100], backgroundColor: ["#36A2EB", "#FF6384"] }] };

    new Chart(document.getElementById('chartValleNilo'), { type: 'doughnut', data: dataValleNilo});
    new Chart(document.getElementById('chartDeltaNilo'), { type: 'doughnut', data: dataDeltaNilo });
    new Chart(document.getElementById('chartDesiertoOccidental'), { type: 'doughnut', data: dataDesiertoOccidental });
    new Chart(document.getElementById('chartDesiertoOriental'), { type: 'doughnut', data: dataDesiertoOriental });
    new Chart(document.getElementById('chartPeninsulaSinai'), { type: 'doughnut', data: dataPeninsulaSinai });
    new Chart(document.getElementById('chartTotalEgipto'), { type: 'doughnut', data: dataTotalEgipto });
