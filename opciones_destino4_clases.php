...
<body>
  ...
  <div class="main-cajon">
    ...
    <div class="form-container">
      <img src="https://www.shutterstock.com/image-vector/hong-kong-vicinity-political-map-260nw-313959137.jpg" alt="Regiones de Hong Kong">
      <form id="regionForm">
        <select id="region" required>
          <option value="">Seleccione una región...</option>
          <option value="Isla">La isla de Hong Kong</option>
          <option value="Kowloon">Kowloon</option>
          <option value="Nterritorios">Nuevos territorios</option>
        </select>
