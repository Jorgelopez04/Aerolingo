...
<head>
  ...
  <style>
    ...
    .menu-icon {
      font-size: 30px; /* Tamaño del icono de menú */
    }
...
<body>
  ...
  <div class="main-cajon">
    ...
    <div class="options-container">
      ...
      <div class="option-cajon" onclick="location.href='Pantalla_principal.php'">
        <h3>No tenemos nada para ofrecerte en este plan</h3>
        <p class="mensaje">Lo sentimos de momento no tengo ninguna guia y ninguna clase que te podamos ofrecer
          estamos trabajando en ello para que tengas mas opciones
        </p>
      </div>
  ...
  <script>
    ...
    function irADestino(destino) {
      window.location.href = destino + ".html"; // Redirigir a la página del destino
    }
  </script>
