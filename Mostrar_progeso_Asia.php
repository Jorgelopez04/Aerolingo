...
<body>
  ...
  <div class="progress-container">
    <h1 class="progress-title">Progreso en tu viaje a Hong Kong</h1> <!-- Título general -->
    <p class="progress-text">Tu progreso es el siguiente</p>

    <div class="charts-container">
      <div class="chart-item">
        <canvas id="chartIsla"></canvas>
        <p>La isla de hong kong</p>
      </div>
      <div class="chart-item">
        <canvas id="chartKowloon"></canvas>
        <p>Kowloon</p>
      </div>
      <div class="chart-item">
        <canvas id="chartNterritorios"></canvas>
        <p>Nuevos territorios</p>
      </div>
      <div class="chart-item">
        <canvas id="chartTotalHongKong"></canvas>
        <p>Total</p>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    // Gráficos circulares
    const dataIsla = { labels: ['Completado', 'Pendiente'], datasets: [{ data: [0, 100], backgroundColor: ["#36A2EB", "#FF6384"] }] };
    const dataKowloon = { labels: ['Completado', 'Pendiente'], datasets: [{ data: [0, 100], backgroundColor: ["#36A2EB", "#FF6384"] }] };
    const dataNterritorios = { labels: ['Completado', 'Pendiente'], datasets: [{ data: [0, 100], backgroundColor: ["#36A2EB", "#FF6384"] }] };
    const dataTotalHongKong = { labels: ['Completado', 'Pendiente'], datasets: [{ data: [0, 100], backgroundColor: ["#36A2EB", "#FF6384"] }] };
    

    new Chart(document.getElementById('chartIsla'), { type: 'doughnut', data: dataIsla});
    new Chart(document.getElementById('chartKowloon'), { type: 'doughnut', data: dataKowloon });
    new Chart(document.getElementById('chartNterritorios'), { type: 'doughnut', data: dataNterritorios });
    new Chart(document.getElementById('chartTotalHongKong'), { type: 'doughnut', data: dataTotalHongKong });
