...
<body>
  ...
  <div class="progress-container">
    <h1 class="progress-title">Progreso en tu viaje a Perú</h1> <!-- Título general -->
...
"#36A2EB","#FF6384"
    ...
    new Chart(document.getElementById('chartSelva'), {
      type: 'doughnut',
      data: dataSelva
    });

    new Chart(document.getElementById('chartSierra'), {
      type: 'doughnut',
      data: dataSierra
    });

    new Chart(document.getElementById('chartCosta'), {
      type: 'doughnut',
      data: dataCosta
    });
